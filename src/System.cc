...
{
    // test 
    std::cout << "---In System::Shutdown---" << std::endl;
    ...
    {
        // test 
        std::cout << "---test mpViewer---" << std::endl;
        mpViewer->RequestFinish();
        // test 
        std::cout << "---test mpViewer 1---" << std::endl;
        while(!mpViewer->isFinished())
            usleep(5000);
        // test 
        std::cout << "---test mpViewer 2---" << std::endl;
    }
    ...
    {
        // test 
        std::cout << "---test mpLocalMapper---" << std::endl;
        usleep(5000);
    }
